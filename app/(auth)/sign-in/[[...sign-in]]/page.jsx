        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-12 py-10 bg-gradient-to-t from-black/80 to-transparent">
            ...
            <p className="mt-4 text-white/90 text-lg">
              Practice mock interviews powered by AI. Improve. Analyze. Succeed. Your smart step
              toward cracking real interviews.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 text-gray-500">
                Mock interviews made smarter with AI. Get real-time insights, performance analytics,
                and feedback to level up your game.
              </p>
            </div>
